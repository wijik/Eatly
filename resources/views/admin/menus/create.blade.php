                        ...
                        <form method="POST" action="{{ route('menus.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    {{-- Preview Gambar --}}
                                    <div class="mb-2">
                                        <img id="preview-gambar" src="#" alt="Preview Gambar" style="display: none; max-height: 200px;" class="img-fluid rounded shadow-sm">
                                    </div>

                                    {{-- Input File --}}
                                    <input class="form-control @error('gambar') is-invalid @enderror" type="file" name="gambar" accept="image/*" onchange="previewGambar(this)" required>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('nama_menu') is-invalid @enderror" type="text" placeholder="Nama Menu" name="nama_menu" required autofocus>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" rows="4" placeholder="Tulis deskripsi menu di sini..." required>{{ old('deskripsi') }}</textarea>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        <option value="{{ $rasa->id_preferensi_rasa }}" {{ old('id_preferensi_rasa') == $rasa->id ? 'selected' : '' }}>
                                            {{ $rasa->nama_rasa }}
                                        </option>
                                        @endforeach
                                    </select>
